...
const checkboxVariants = cva(
  'flex flex-none cursor-pointer items-center justify-center rounded-[5px] outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-disabled:opacity-20 aria-invalid:focus-visible:ring-destructive/50 data-checked:bg-primary data-checked:text-primary-foreground data-disabled:cursor-not-allowed data-disabled:bg-muted-foreground data-indeterminate:border data-unchecked:border aria-invalid:data-unchecked:border-destructive',
  {
    variants: {
      size: {
