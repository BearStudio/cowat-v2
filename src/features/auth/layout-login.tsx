  ...
  return (
    ...
    >
      ...
      <div className="relative m-4 hidden flex-1 overflow-hidden rounded-3xl lg:flex">
        ...
        <div className="absolute -top-32 -right-32 size-96 rounded-full bg-brand-600/20 blur-3xl" />
        <div className="absolute -bottom-24 -left-24 size-72 rounded-full bg-brand-500/15 blur-3xl" />
      </div>
    </div>
  );
};
